...
urlpatterns = [
	...
	url(r'^subject/(?P<subject_name_slug>[\w\-]+)/(?P<videoID>\d+)/add_quiz/$', views.add_quiz, name='add_quiz'),
    url(r'^create-quiz/(?P<quizID>\d+)/$', views.add_question, name='add_question'),
